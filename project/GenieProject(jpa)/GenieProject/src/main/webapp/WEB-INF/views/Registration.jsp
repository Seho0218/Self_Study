	...
	<div class="wrapper">
		...
		<form method="post" action="/UserWrite" id="logFrm">
			...
			<ul id="passwordForm">
				...
				<li>비밀번호 확인</li>
				<input type="password" id="genie_pwd2" name="geniePwd" value="123" placeholder="비밀번호를 입력하세요">
			</ul>
			<ul id="idForm">
				<li>이름</li>
				<input type="text" name="user_name" id="userName" value="김유저" placeholder="이름을 입력하세요">
			</ul>
			<ul id="phoneForm">
				<li>휴대폰 번호</li>
